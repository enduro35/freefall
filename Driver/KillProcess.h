...
typedef NTSTATUS (*PSPTERMINATETHREADBYPOINTER_K)( PETHREAD,NTSTATUS,BOOLEAN);   //2003,vista,2008ÏÂ
PSPTERMINATETHREADBYPOINTER_K PspTerminateThreadByPointer_K;

typedef NTSTATUS (*PSPTERMINATETHREADBYPOINTER_XP)( PETHREAD,NTSTATUS);             //xpÏÂ
